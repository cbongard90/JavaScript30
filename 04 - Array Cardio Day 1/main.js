...
const sortedAge = inventors.sort((a, b) => {
  const lastInventor = yearsLived(a);
  const nextInventor = yearsLived(b);
...
// const links = [...category.querySelectorAll("a")]; // another option to get the array is using Array.from()
// const de = list
...
const ordered = people.sort((lastOne, nextOne) => {
